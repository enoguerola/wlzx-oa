...
INSERT INTO `wlzx_system` (`id`, `symbol`, `name`, `detail`, `creation_date`, `modified_date`) VALUES
(1, 'root', '温岭数字化校园系列', '数字化校园信息平台是以学校现有网络为基础，以服务于全校师生的教学、科研、生活为目的，建立在学校数据中心平台之上，涵盖了学校的信息化标准管理、学校管理、学生管理、教学管理、教职工管理、科研管理、财务管理、资产与设备管理、行政办公管理、数字图书资料管理等全方位的管理信息平台与信息服务平台。', '2011-04-20 11:01:10', '2011-04-20 11:01:10'),
(2, 'basic', '基础数据系统', '基础数据系统是数字化校园所有业务应用系统的公共数据库，处于中心位置，基础数据库保持最完整、最准确的数据，提供其他业务系统使用。基础数据库管理系统实现对基础数据库所有信息库的维护管理。', '2011-04-20 11:01:10', '2011-04-20 11:01:10'),
(3, 'oa', '办公自动化系统', '办公自动化系统以公文流转为核心，实现办公流程的快速高效；同时提供多种部门间的信息交流的手段和渠道，加强部门间的沟通协作；提供信息共享的平台，实现公共资源的共享；提供辅助办公功能，为每一项业务提供相关信息，促进学校办公的成熟和规范化；提供强大的搜索查询功能，便于用户在日积月累的海量信息中快速的查找需要的内容', '2011-04-20 11:01:10', '2011-04-20 11:01:10');
...
(1, '全部', 'basic_authorization_department_main_edit_deafultFilter', 'NULL', NULL, '2011-04-20 11:01:10', '2011-04-20 11:01:10'),
(2, '全部', 'basic_authorization_department_main_search_deafultFilter', 'NULL', NULL, '2011-04-20 11:01:10', '2011-04-20 11:01:10');
...
CREATE TABLE IF NOT EXISTS `wlzx_system_department` (
  ...
  `modified_date` timestamp NOT NULL default '0000-00-00 00:00:00' on update CURRENT_TIMESTAMP,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统部门' AUTO_INCREMENT=1 ;
...
(1, '系统授权', 'basic_authorization', NULL, '2011-04-20 11:01:10', '2011-04-20 11:01:10'),
(2, '部门授权', 'basic_authorization_department', NULL, '2011-04-20 11:01:10', '2011-04-20 11:01:10'),
(3, '部门角色授权', 'basic_authorization_role', NULL, '2011-04-20 11:01:10', '2011-04-20 11:01:10'),
(4, '基础数据', 'basic_data', NULL, '2011-04-20 11:01:10', '2011-04-20 11:01:10'),
(5, '员工基础数据', 'basic_data_staff', NULL, '2011-04-20 11:01:10', '2011-04-20 11:01:10'),
(6, '系统设置', 'basic_setting', NULL, '2011-04-20 11:01:10', '2011-04-20 11:01:10');
...
(1, '部门授权主模块', 'basic_authorization_department_main', NULL, '2011-04-20 11:01:10', '2011-04-20 11:01:10', NULL);
...
(1, '编辑', 'basic_authorization_department_main_edit', NULL, '', '2011-04-20 11:01:10', '2011-04-20 11:01:10'),
(2, '查询', 'basic_authorization_department_main_search', NULL, '', '2011-04-20 11:01:10', '2011-04-20 11:01:10');
